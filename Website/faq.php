                	...
                	<div class="col-sm-12">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="links.html" id="circle-nav" class="tooltips" title="Resources"><img src="images/IconLinks.png"></a></li>
     ...
     <div class="container">
	  	<div class="row">
	 		<div class="col-sm-8 col-sm-offset-2">
	 			<div id="title"><h1>IncludeME FAQs</h1></div>
	 			<div id="tabs-container">
		 			<ul class="tabs-menu">
				        <li id="tab-yp" class="current"><a href="#tab-1">Young People</a></li>
				        <li id="tab-clinician"><a href="#tab-2">Clinicians</a></li>
				        <li id="tab-parents"><a href="#tab-3">Parents</a></li>
	    			</ul>
